use sapiens_sys::{spNoiseDelete, spNoiseGet, spNoiseNew, SPNoise, SPVec3};
...
impl Noise {
    ...
    ///     performance
    pub fn get(&self, pos: &SPVec3, end_octave: i32) -> f64 {
        unsafe { spNoiseGet(self.as_sp_noise(), *pos, end_octave) }
    }
